...
#con =mysql.connector.connect(host = 'localhost',user = 'root', password='siva',database = 'daily_fresh')  Works in local host
print( 'MYSQL DB database for order page connection successful')
